...
> These decisions were resolved for the light-theme + case-study direction,
> which the Founder has since replaced with a request to replicate
> wabdigital.com directly. See the current `Open_Decision.md` for active
> open items.
>
> ---
