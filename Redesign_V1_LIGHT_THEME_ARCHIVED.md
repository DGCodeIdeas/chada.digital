> # ⚠️ ARCHIVED — SUPERSEDED Aug 20, 2026
> This spec (light theme + case-study system) was team-approved and partially
> implemented (Phases 1-3), but the Founder has since requested a direct
> replicate of wabdigital.com instead. Kept here for history and because real
> engineering work landed against this version — see the current `Redesign.md`
> for the active direction, and its own notes on what to do with the code
> already built for this version.
>
> ---
