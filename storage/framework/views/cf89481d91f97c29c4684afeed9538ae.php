...
<?php endif; ?>
<?php $component->withAttributes([]); ?>Exclusivity <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-4']); ?><?php echo e($exclusivity['headline']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        <p class="mt-4 text-base text-muted-foreground"><?php echo e($exclusivity['body']); ?></p>
        <div class="mt-8">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(url('/#contact')).'']); ?>Start a Project <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/dgi/www/chada.digital/resources/views/partials/exclusivity-cta.blade.php ENDPATH**/ ?>