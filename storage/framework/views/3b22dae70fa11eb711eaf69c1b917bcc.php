        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="group rounded-2xl border border-border bg-card p-8 transition-all duration-300 hover:-translate-y-1 hover:border-primary/40">
                    ...
                    <h3 class="font-display text-lg font-bold tracking-tight"><?php echo e($service['title']); ?></h3>
                    <p class="mt-3 text-sm leading-relaxed text-muted-foreground"><?php echo e($service['desc']); ?></p>
                    <p class="mt-4 text-xs text-muted-foreground"><?php echo e(implode(' · ', $service['stack'])); ?></p>
...
<?php /**PATH /home/dgi/www/chada.digital/resources/views/partials/services.blade.php ENDPATH**/ ?>