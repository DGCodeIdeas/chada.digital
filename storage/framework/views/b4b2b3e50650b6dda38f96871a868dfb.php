<header class="sticky top-0 z-50 border-b border-neutral-200 bg-background/85 backdrop-blur-xl">
    <div class="mx-auto flex h-16 max-w-7xl items-center justify-between gap-6 px-6">
        ...
        <nav class="hidden items-center gap-7 lg:flex">
            ...
            <a class="text-sm font-medium text-muted-foreground transition-colors hover:text-foreground" href="<?php echo e(url('/#services-checklist')); ?>">Services</a>
            <a class="text-sm font-medium text-muted-foreground transition-colors hover:text-foreground" href="<?php echo e(url('/#founder')); ?>">About</a>
