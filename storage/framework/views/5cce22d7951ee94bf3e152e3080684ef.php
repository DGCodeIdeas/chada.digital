<section class="relative overflow-hidden px-6 pb-20 pt-12 md:pt-20" id="hero">
    ...
    <div class="relative mx-auto max-w-7xl">
        <div>
            ...
            <p class="mt-10 text-sm font-medium uppercase tracking-widest text-muted-foreground">Trusted by 50+ brands</p>
        </div>
    </div>
</section>
<?php /**PATH /home/dgi/www/chada.digital/resources/views/partials/hero.blade.php ENDPATH**/ ?>