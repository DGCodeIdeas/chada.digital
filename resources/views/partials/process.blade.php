        ...
        <ol class="grid gap-8 lg:grid-cols-4">
            @foreach($steps as $step)
                <li class="relative flex flex-col items-center text-center">
                    ...
                    <span class="text-sm font-semibold tracking-widest text-primary">{{ $step['number'] }}</span>
                    <h3 class="mt-2 font-display text-lg font-bold tracking-tight">{{ $step['title'] }}</h3>
