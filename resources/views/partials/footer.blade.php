        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('home') }}" class="d-inline-block mb-2">
                    <img src="{{ asset('chada-logo-horizontal-dark.png') }}" alt="{{ config('brand.name') }}" height="28">
                </a>
                <p class="mb-2" style="color: var(--md-sys-color-on-surface-variant); font-size: 0.875rem; max-width: 320px; line-height: 1.6;">
                    {{ config('brand.footer_tagline') }}
                </p>
                <div class="d-flex gap-2">
                    <a href="{{ config('social.linkedin') }}" style="color: var(--md-sys-color-on-surface-variant);" aria-label="LinkedIn">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>
                    <a href="{{ config('social.instagram') }}" style="color: var(--md-sys-color-on-surface-variant);" aria-label="Instagram">
                    ...
                    <a href="{{ config('social.twitter') }}" style="color: var(--md-sys-color-on-surface-variant);" aria-label="Twitter">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <ul class="list-unstyled mb-0" style="font-size: 0.8125rem; color: var(--md-sys-color-on-surface-variant);">
                    <li class="mb-2 d-flex align-items-center gap-2">
                        ...
                        <a href="mailto:{{ config('contact.email') }}" style="color: var(--md-sys-color-on-surface-variant);">{{ config('contact.email') }}</a>
                    </li>
                    <li class="mb-2 d-flex align-items-center gap-2">
                        ...
                        <a href="tel:{{ config('contact.phone') }}" style="color: var(--md-sys-color-on-surface-variant);">{{ config('contact.phone_display') }}</a>
                    </li>
                    <li class="mb-2 d-flex align-items-center gap-2">
