<section class="px-6 py-20 md:py-28" id="portfolio">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            @include('partials.project-card', ['slug' => 'sterling-vale', 'image' => 'project-sterling.jpg', 'title' => 'Sterling & Vale', 'description' => 'Construction Firm — Corporate Website'])
            @include('partials.project-card', ['slug' => 'apexflow', 'image' => 'project-apexflow.jpg', 'title' => 'ApexFlow', 'description' => 'SaaS Platform — AI Automation'])
            @include('partials.project-card', ['slug' => 'hirebase', 'image' => 'project-hirebase.jpg', 'title' => 'HIREBASE', 'description' => 'Recruitment — Job Board Platform'])
        </div>
    </div>
</section>
