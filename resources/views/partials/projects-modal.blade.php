        ...
        <div class="modal-panel relative w-full max-w-6xl max-h-[85dvh] flex flex-col overflow-hidden rounded-2xl border border-border bg-[#0e1b2e] shadow-2xl transition-all duration-300" style="opacity:0;transform:scale(0.95) translateY(1rem)">
            ...
            <div class="flex-1 overflow-y-auto p-6 sm:p-8" style="-webkit-overflow-scrolling:touch;overscroll-behavior:contain">
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                    <a href="{{ route('preview.show', 'sterling-vale') }}" rel="noopener" target="_blank" class="group block overflow-hidden rounded-xl border border-border bg-[#0b1526] transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
                        <div class="relative overflow-hidden">
                            <img alt="Sterling & Vale" class="aspect-[4/3] w-full object-cover transition-transform duration-700 group-hover:scale-105" src="{{ asset('assets/images/project-sterling.jpg') }}" loading="lazy" />
                    ...
                    <a href="{{ route('preview.show', 'apexflow') }}" rel="noopener" target="_blank" class="group block overflow-hidden rounded-xl border border-border bg-[#0b1526] transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
                        <div class="relative overflow-hidden">
                            <img alt="ApexFlow" class="aspect-[4/3] w-full object-cover transition-transform duration-700 group-hover:scale-105" src="{{ asset('assets/images/project-apexflow.jpg') }}" loading="lazy" />
                            <div class="absolute inset-0 bg-gradient-to-t from-[#0b1526] via-transparent to-transparent opacity-60"></div>
                        </div>
                        <div class="p-5">
                    ...
                    <a href="{{ route('preview.show', 'noir') }}" rel="noopener" target="_blank" class="group block overflow-hidden rounded-xl border border-border bg-[#0b1526] transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
                        <div class="relative overflow-hidden">
                            <img alt="NOIR" class="aspect-[4/3] w-full object-cover transition-transform duration-700 group-hover:scale-105" src="{{ asset('assets/images/project-noir.jpg') }}" loading="lazy" />
                            <div class="absolute inset-0 bg-gradient-to-t from-[#0b1526] via-transparent to-transparent opacity-60"></div>
                        </div>
                        <div class="p-5">
                    ...
                    <a href="{{ route('preview.show', 'elysian') }}" rel="noopener" target="_blank" class="group block overflow-hidden rounded-xl border border-border bg-[#0b1526] transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
                        <div class="relative overflow-hidden">
                            <img alt="ELYSIAN" class="aspect-[4/3] w-full object-cover transition-transform duration-700 group-hover:scale-105" src="{{ asset('assets/images/project-elysian.jpg') }}" loading="lazy" />
                            <div class="absolute inset-0 bg-gradient-to-t from-[#0b1526] via-transparent to-transparent opacity-60"></div>
                        </div>
                        <div class="p-5">
                    ...
                    <a href="{{ route('preview.show', 'hirebase') }}" rel="noopener" target="_blank" class="group block overflow-hidden rounded-xl border border-border bg-[#0b1526] transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
                        <div class="relative overflow-hidden">
                            <img alt="HIREBASE" class="aspect-[4/3] w-full object-cover transition-transform duration-700 group-hover:scale-105" src="{{ asset('assets/images/project-hirebase.jpg') }}" loading="lazy" />
                            <div class="absolute inset-0 bg-gradient-to-t from-[#0b1526] via-transparent to-transparent opacity-60"></div>
                        </div>
                        <div class="p-5">
