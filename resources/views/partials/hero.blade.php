    ...
    <div class="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
        <div>
            ...
            <div class="mt-8 flex flex-wrap gap-4">
                ...
                <a class="inline-flex items-center gap-2 rounded-full border border-primary/40 px-7 py-3.5 text-xs font-semibold uppercase tracking-widest text-primary transition-colors hover:bg-primary/10" href="{{ url('/#portfolio') }}">
                    View Our Work
