...
<meta name="copyright" content="{{ config('brand.name') }}" />
...
<meta property="og:site_name" content="{{ $meta['og_site_name'] ?? config('brand.name') }}" />
<meta property="og:title" content="{{ $meta['og_title'] ?? config('brand.name') . ' | ' . config('brand.tagline') }}" />
<meta property="og:description" content="{{ $meta['og_description'] ?? config('brand.tagline') }}" />
...
<meta property="og:image:alt" content="{{ $meta['og_image_alt'] ?? config('brand.name') . ' | ' . config('brand.tagline') }}" />
<meta name="twitter:card" content="{{ $meta['twitter_card'] ?? 'summary_large_image' }}" />
<meta name="twitter:title" content="{{ $meta['twitter_title'] ?? config('brand.name') . ' | ' . config('brand.tagline') }}" />
<meta name="twitter:description" content="{{ $meta['twitter_description'] ?? config('brand.tagline') }}" />
