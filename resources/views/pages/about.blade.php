...
<section style="background: linear-gradient(135deg, #f8f6f3 0%, #f0ede8 100%); padding: 5rem 0 3rem;">
    <div class="container text-center">
        ...
        <p class="mx-auto" style="max-width: 700px; color: var(--md-sys-color-on-surface-variant); font-size: 1.125rem;">
            Chada Digital is a Lagos-based digital agency specialising in web development, funnel automation, paid advertising, and brand strategy. We do not just build websites — we build systems that turn visitors into customers, and customers into repeat buyers.
        </p>
    </div>
</section>
