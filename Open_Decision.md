...
> `archive/Open_Decision_V1_LIGHT_THEME_ARCHIVED.md` (historical — not in repo). Read `MIGRATION.md` first — this doc's decisions still apply, but the build spec has moved to Bootstrap + MD3 — this
